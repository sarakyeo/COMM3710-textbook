...
::: {.callout-tip}
Remember that you can use @fig-select-test to select a statistical test that is appropriate for the level of measurement of the variables.
:::
